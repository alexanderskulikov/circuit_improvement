...
\begin{tikzpicture}[label distance=-.9mm,scale=.8]
\foreach \n/\x/\y in {1/0/1, 2/1/1}
  \node[input] (x\n) at (\x, \y) {$x_{\n}$};
...
State-of-the-art SAT solvers are surprisingly efficient and allow to~handle
...
%\draw[help lines] (0,-5) grid (16,6);
\begin{scope}[xshift=20mm, yshift=60mm]
%\draw[help lines] (0,-3) grid (4,4);
