...
for file_name in sorted(os.listdir('circuits')):
    ...
    print(f'--> Trying to improve {file_name} of size {circuit.get_nof_true_binary_gates()}')
    improve_circuit_iteratively(circuit, file_name=file_name, basis='aig', save_circuits=True, speed=10)
