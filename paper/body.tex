...
\todo[inline]{Danya, Nikita, I've rewritten the paragraph below. Please check it}
...
\begin{itemize}
    ...
    \item We~get new upper bounds for the threshold function defined as~follows:
    \[\THR_n^k(x_1, \dotsc, x_n)=[x_1+\dotsb+x_n \ge k] \, .\]
    The best known circuits for $\THR$ are the following:
    \begin{align*}
    ...
    \begin{align*}
        ...
        \size(\THR_n^k) &\le (4.5-3/2^{\lceil \log_2k\rceil})n+o(n) \text{ for $5 \le k = O(1)$.}
    \end{align*}
\end{itemize}
