...
it~remains to~compute the disjunction of the remaining $n-1$ bits to~check whether there~is at~least one~$1$.
In~general, this leads to~a~circuit of~size $3n-5$.}
\label{figure:thr31}
\end{figure}

\todo[inline]{Nikita, poprav' levuyu kartinku, pogaluista}
...
\todo[inline]{Nikita, na levoi kartinke pomenyai, pogaluista, $r$-ki i $c$-ki mestami. Potom pomenyayi escho ne pravoi kartinke i sdelai tak, chtobi leible bili poblige k geitam.}
