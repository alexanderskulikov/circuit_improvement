...
$\size(\OUT_1^1) \le ?$,
$\size(\OUT_3^2) \le ?$.
\todo[inline]{Nikita, fill in these question marks}
...
computed as $s=\size(\IN_k)+9m+\size(\OUT_r^l)$.}
\label{table:parameters}
\end{table}
\todo[inline]{Nikita, complete the table}
\end{proof}
