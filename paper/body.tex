...
%We~report the results of experiments with various 
%symmetric functions. 
Through this approach, we~prove
new upper bounds on the circuit size of~some
symmetric functions. We~also demonstrate that
...
%
This circuit can~be also found via \mintinline{python}{find_circuit} directly, but it takes about seven hours.\todo{update}
